...
def test_end_to_end_pipeline():
    ...
    with patch.dict(
        os.environ, {"KAFKA_BOOTSTRAP_SERVERS": "localhost:9092", "STOCK_SYMBOLS": "AAPL"}
    ):
...
class TestStockDataProducer:
    ...
    def producer(self):
        ...
        with patch.dict(
            os.environ, {"KAFKA_BOOTSTRAP_SERVERS": "localhost:9092", "STOCK_SYMBOLS": "AAPL,GOOGL"}
        ):
...
class TestCryptoDataProducer:
    ...
    def producer(self):
        ...
        with patch.dict(
            os.environ,
            {"KAFKA_BOOTSTRAP_SERVERS": "localhost:9092", "CRYPTO_SYMBOLS": "bitcoin,ethereum"},
        ):
...
class TestDataQuality:
    ...
    def test_data_type_validation(self):
        ...
        sample_data = {"symbol": "AAPL", "close_price": 151.5, "volume": 1000000}
